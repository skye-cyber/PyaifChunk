...
import builtins
import warnings
from ..pychunk.chunk import Chunk
__all__ = ["Error", "open"]


# python-deadlib: Replace deprecation warning not to raise exception
warnings.warn(
    f"aifc was removed in Python 3.13. "
    f"Please be aware that you are currently NOT using standard 'aifc', "
    f"but instead a separately installed 'standard-aifc: {__name__}'.",
